...
Select * from PortfolioProject..CovidDeaths1$ WHERE continent is not null order by 3,4
...
From PortfolioProject..CovidDeaths1$ WHERE continent is not null Order by 1,2

--Looking at Total Cases vs Total Deaths 
-- Shows likelihood of dying if you contract covid in your country
Select Location,date,total_cases,total_deaths , (total_deaths/total_cases)*100 as DeathPercentage
From PortfolioProject..CovidDeaths1$  where location='India' and continent is not null Order by 1,2
...
From PortfolioProject..CovidDeaths1$  where location='India' Order by 1,2

--Looking at Countries with Highest Infection Rate compared to Population
 
 Select Location , Population, Max(Total_cases) as HighestInfectionCount, Max((total_cases/population)*100) as PercentPopulationInfected
 from PortfolioProject..CovidDeaths1$ WHERE continent is not null
